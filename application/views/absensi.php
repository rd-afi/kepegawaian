      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <button class="btn btn-success" onclick="add_absensi()"><i class="glyphicon glyphicon-plus"></i> Add Tunjangan</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({
        ...
        "ajax": {
            "url": "<?php echo site_url('akun/ajax_list_absensi')?>",
            "type": "POST"
        },
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('akun/ajax_add_absensi')?>";
    } else if (save_method == 'update') {
        url = "<?php echo site_url('akun/ajax_update_absensi')?>";
    }
...
function delete_tunjangan(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('akun/ajax_delete_absensi')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" name="cbAbsensi" id="cbAbsensi">
                          ...
                          <?php foreach($absensi->result_array() as $row) {?>
                            <option name="cbAbs" id="cbAbs" value="<?php echo $row['nip'];?>">
