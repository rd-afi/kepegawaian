...
function edit_jabatan(kdJabatan)
{
    save_method = 'update';
    $('#form')[0].reset(); // reset form on modals
    $('.form-group').removeClass('has-error'); // clear error class
    ...
    $.ajax({
        url : "<?php echo site_url('jabatan/ajax_edit/')?>/" + kdJabatan,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {

            $('[name="kdJabatan"]').val(data.kdJabatan);
            $('[name="namaJabatan"]').val(data.namaJabatan);
...
function delete_jabatan(kdJabatan)
{
    if(confirm('Are you sure delete this data?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('jabatan/ajax_delete')?>/"+kdJabatan,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <input type="hidden" value="" name="kdJabatan"/> 
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama Jabatan</label>
                            <div class="col-md-9">
                                <input name="namaJabatan" placeholder="Nama Jabatan" class="form-control" type="text">
