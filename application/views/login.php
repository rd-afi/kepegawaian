...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link href="<?php echo base_url('assets/template/plugins/iCheck/square/blue.css') ?>" rel="stylesheet" type="text/css" />
    ...
    <body class="login-page">
        ...
        <!-- jQuery 2.1.3 -->
        <script src="<?php echo base_url('assets/template/plugins/jQuery/jQuery-2.1.3.min.js') ?>"></script>
        <!-- Bootstrap 3.3.2 JS -->
