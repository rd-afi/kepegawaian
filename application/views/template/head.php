...
<html>
    <head>
        ...
        <link href="<?php echo base_url('assets/template/plugins/iCheck/all.css') ?>" rel="stylesheet" type="text/css" />
        <!-- bootstrap datepicker -->
        <link href="<?php echo base_url('assets/template/plugins/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') ?>" rel="stylesheet" type="text/css" />
        <!-- Theme style -->
